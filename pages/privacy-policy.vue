...
import ContentPages from "~/services/ContentPages";
export default {
  components: {
  ...
  // asyncData({ error }) {
  //   return ContentPages.getPage("PRIVACY_POLICY")
  //     .then((res) => {
  //       return { pageData: res.data.clientpage };
  //     })
  //     .catch((e) => {
  ...
  head() {
    return {
      title: this.config?.title + " - Privacy Policy",
    };
  },
};
</script>
